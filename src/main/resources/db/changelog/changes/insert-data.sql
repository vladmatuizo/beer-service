...
insert into beer (id, beer_name, beer_style, created_date, last_modified_date, min_on_hand, quantity_to_brew, price, upc, version) values ('0a818933-087d-47f2-ad83-2f986ed087eb', 'Mango Boss', 'IPA', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 12, 200, 12.95, '0631234200036', 1);
...
--rollback delete from beer where id in ('0a818933-087d-47f2-ad83-2f986ed087eb', 'a712d914-61ea-4623-8bd0-32c0f6545bfd', '026cc3c8-3a0c-4083-a05b-e908048c1b08');
